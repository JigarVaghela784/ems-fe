...
// ** Custom Components
import CustomDatePicker from '../../@core/layouts/components/shared-components/CustomDatePicker'
    ...
    <CardContent>
      <form>
        <Grid container spacing={7}>
          ...
          <Grid item xs={12} sm={6}>
            <CustomInput fullWidth type='number' label='Phone' placeholder='(123) 456-7890' />
          </Grid>
          <Grid item xs={12} sm={6}>
            <CustomInput
              fullWidth
